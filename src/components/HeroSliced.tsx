...
export function HeroSliced() {
  ...
  return (
    <section className="relative min-h-screen w-full bg-neutral-950 text-white flex items-center justify-center p-6 md:p-12 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full max-w-7xl h-full items-center">
        ...
        <div className="flex flex-col justify-center h-full z-20 order-2 lg:order-1">
           ...
           >
             ...
             <h1 className="text-6xl md:text-8xl xl:text-9xl font-bold uppercase tracking-tighter leading-[0.85] text-neutral-100">
               DEN<br/>VANSKELIGE<br/>SAMTALEN
             </h1>
             <p className="mt-10 text-lg md:text-xl text-neutral-400 max-w-md font-light leading-relaxed">
           ...
           <motion.div 
             ...
             className="mt-16 flex flex-col gap-3 text-xs md:text-sm text-neutral-600 uppercase tracking-widest font-mono"
           >
        ...
        {/* Sliced Image Right */}
        <div className="relative w-full h-[60vh] md:h-[80vh] flex flex-col gap-[5px] order-1 lg:order-2">
          {[...Array(slices)].map((_, i) => (
            <motion.div 
              ...
              className="relative w-full flex-1 overflow-hidden bg-neutral-900/50"
            >
               <div 
