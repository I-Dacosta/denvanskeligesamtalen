...
export const metadata: Metadata = {
  ...
  description: "En kunstnerisk utforskning av dialogens potensiale. Et prosjekt av Unni Gjertsen og Runa Carlsen med podkast, performance og teater om samtalen som kunstverk. Støttet av Fritt Ord.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "En kunstnerisk utforskning av dialogens potensiale. Podkast, performance og teater av Unni Gjertsen og Runa Carlsen.",
    ...
    "@graph": [
      {
        ...
        "description": "Et kunstprosjekt om dialogens potensiale av Unni Gjertsen og Runa Carlsen",
        "founder": [
          {
            "@type": "Person",
            "name": "Unni Gjertsen"
      ...
      },
      {
        ...
        "name": "Den Vanskelige Samtalen",
        "description": "Et kunstprosjekt som utforsker dialog gjennom podkast, performance og teater",
        "creator": [
          {
            "@type": "Person",
            "name": "Unni Gjertsen"
